...
// ** هام: استخدام المتغيرات البيئية من Vercel لأمان المفاتيح **
...
        // ** هذا هو الكود الجديد للبحث في جميع خوادم ببجي موبايل **
...
                    break; // الخروج من الحلقة بمجرد العثور على اللاعب
                }
            } catch (error) {
                // تجاهل الخطأ والمحاولة مع الخادم التالي
                continue;
            }
        }
